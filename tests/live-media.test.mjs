...
import { buildLiveMediaEndpoints, getLiveMediaConfig, streamPathForId } from '../api/_lib/liveMedia.js'
...
test('MediaMTX adapter rejects missing or credential-bearing configuration', () => {
  delete process.env.LIVE_MEDIA_SERVER_URL
  assert.throws(() => getLiveMediaConfig(), /LIVE_MEDIA_SERVER_URL/)
